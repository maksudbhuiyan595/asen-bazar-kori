                ...
                @if($myCart !=null)
                    ...
                    <td class="p-4">
                      <div class="media align-items-center">
                        <img src="{{url('/uploads/products/'.$cart['image'])}}" class="d-block ui-w-40 ui-bordered mr-4" alt="image">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center pb-4">
              ...
              <div class="d-flex">
                ...
                <div class="text-right mt-4">
                  ...
                  <div class="text-large"><strong>{{$myCart?array_sum(array_column($myCart,'sub_total')):0}} BDT.</strong></div>
                </div>
              </div>
            </div>
